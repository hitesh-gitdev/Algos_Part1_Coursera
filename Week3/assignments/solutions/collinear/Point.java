...
public class Point implements Comparable<Point> {
    ...
    public int compareTo(Point that) {
        ...
        if (that == null) {
            ...
            throw new NullPointerException("Illegal argument: null point.");
        }
    ...
    public Comparator<Point> slopeOrder() {
        ...
        return new Comparator<Point>() {
            public int compare(Point p1, Point p2) {
                ...
                if (p1 == null || p2 == null) {
                    throw new NullPointerException("Illegal point argument: null");
                }

                final double slope1 = slopeTo(p1);
                final double slope2 = slopeTo(p2);
                if (p1 == Point.this || slope1 < slope2) {
                    return -1;
                }
                else if (p2 == Point.this || slope1 > slope2) {
                    return 1;
                }
                else {
                    return 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Slope q->r: " + q.slopeTo(r));
        ...
        // Point collinear to p and q
        Point s = new Point(3, 4);

        System.out.println("Slope p->s: " + p.slopeTo(s));
        System.out.println("Slope q->s: " + q.slopeTo(s));
